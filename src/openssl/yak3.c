...
void YAK_STEP1_init(YAK_STEP1 *s1)
    {
    YAK_STEP_PART_init(&s1->p1);
    YAK_STEP_PART_init(&s1->p2);
    }

void YAK_STEP1_release(YAK_STEP1 *s1)
    {
    YAK_STEP_PART_release(&s1->p2);
    YAK_STEP_PART_release(&s1->p1);
    }
...
static int verify_zkp(const YAK_STEP_PART *p, const BIGNUM *zkpg,
		      YAK_CTX *ctx)
    {
    BIGNUM *h = BN_new();
    BIGNUM *t1 = BN_new();
...
int YAK_STEP1_process(YAK_CTX *ctx, const YAK_STEP1 *received)
    {
    if(!is_legal(received->p1.gx, ctx))
	{
	YAKerr(YAK_F_YAK_STEP1_PROCESS, YAK_R_G_TO_THE_X3_IS_NOT_LEGAL);
	return 0;
	}

    if(!is_legal(received->p2.gx, ctx))
	{
	YAKerr(YAK_F_YAK_STEP1_PROCESS, YAK_R_G_TO_THE_X4_IS_NOT_LEGAL);
	return 0;
	}
   ...
   /* verify their ZKP(xc) */
	...
	{
	YAKerr(YAK_F_YAK_STEP1_PROCESS, YAK_R_VERIFY_X3_FAILED);
	return 0;
	}
   ...
   /* verify their ZKP(xd) */
	...
	{
	YAKerr(YAK_F_YAK_STEP1_PROCESS, YAK_R_VERIFY_X4_FAILED);
	return 0;
	}
   ...
   /* g^xd != 1 */
	...
	{
	YAKerr(YAK_F_YAK_STEP1_PROCESS, YAK_R_G_TO_THE_X4_IS_ONE);
	return 0;
	}
...
int YAK_STEP2_generate(YAK_STEP2 *send, YAK_CTX *ctx)
    {
    BIGNUM *t1 = BN_new();
    BIGNUM *t2 = BN_new();
...
int YAK_STEP2_process(YAK_CTX *ctx, const YAK_STEP2 *received)
    {
    BIGNUM *t1 = BN_new();
    BIGNUM *t2 = BN_new();
    int ret = 0;
   ...
   /* t1 = g^{xc} * t2 = g^{xc + xa + xb} */
	...
	YAKerr(YAK_F_YAK_STEP2_PROCESS, YAK_R_VERIFY_B_FAILED);
...
void YAK_STEP3A_init(YAK_STEP3A *s3a)
    {}

int YAK_STEP3A_generate(YAK_STEP3A *send, YAK_CTX *ctx)
    {
...
int YAK_STEP3A_process(YAK_CTX *ctx, const YAK_STEP3A *received)
    {
	...
	{
	YAKerr(YAK_F_YAK_STEP3A_PROCESS, YAK_R_HASH_OF_HASH_OF_KEY_MISMATCH);
	return 0;
	}
    return 1;
    }

void YAK_STEP3A_release(YAK_STEP3A *s3a)
    {}

void YAK_STEP3B_init(YAK_STEP3B *s3b)
    {}

int YAK_STEP3B_generate(YAK_STEP3B *send, YAK_CTX *ctx)
    {
...
int YAK_STEP3B_process(YAK_CTX *ctx, const YAK_STEP3B *received)
    {
	...
	{
	YAKerr(YAK_F_YAK_STEP3B_PROCESS, YAK_R_HASH_OF_KEY_MISMATCH);
	return 0;
	}
    return 1;
    }

void YAK_STEP3B_release(YAK_STEP3B *s3b)
    {}
